...
const ContactList = (props) => {
  ...
  const fetchingContact = async () => {
    setLoading(true);
    const jsonData = await fetch("https://abishek759.github.io/Api/user.json")
  ...
  const deleteContactFromTheList = (id) => {
    fetch(`https://abishek759.github.io/Api/user.json/${id}`, {
      method: "DELETE",
    });
  ...
  const updateContactFromTheList = (value) => {
    ...
    fetch(`https://abishek759.github.io/Api/user.json/${value.id}`, {
      method: "PUT",
